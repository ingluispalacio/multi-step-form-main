...
function Step2() {
  ...
  const renderCardPlan = (plan) => {
    ...
    return (
      <div
        ...
        className={`flex gap-2 items-center p-2 border rounded-lg cursor-pointer transition
          ${isActive
  ...
  return (
    <div className="px-6 py-3 flex flex-col gap-2">
      <h1 className="text-[18px] font-bold">Select your plan</h1>
      <p className="text-gray-500 text-[14px]">You have the option of monthly or yearly billing.</p>
      ...
      <div className="flex justify-around items-center px-4 py-2 bg-[#BFE0FF]/20 rounded-xl">
        ...
        <label className="text-xs font-semibold">Yearly</label>
      </div>
    </div>
  );
}
